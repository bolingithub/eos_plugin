package android.src.main.kotlin.com.develop.wallet.eos.crypto.utils;
...
//				.putLong(Long.parseLong(amount));
    ...
    public static byte[] writerKey(String key) {
        com.develop.wallet.eos.crypto.utils.ByteBuffer bf = new com.develop.wallet.eos.crypto.utils.ByteBuffer();
